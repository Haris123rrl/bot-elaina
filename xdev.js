...
offline = false
targetpc = '0'
ownerNumber = ["6285936162097@s.whatsapp.net"]
fake = 'CREATED Yt haris.m\n© haris'
fake1 = 'haris'
numbernye = '0'
waktu = '-'
alasan = '-'
...
module.exports = xdev = async (xdev, dev) => {
	try {
        ...
        //FAKEREPLY PRODUCT
            const ftoko = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6285936162097@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./stik/thumb.jpeg`)},"title": `NGEJUDI GAK BROH?\n${pushname}`,"description": "DashBot", "currencyCode": "IDR","priceAmount1000": "9999999999","retailerId": "DashBot original","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
            //FAKE KONTAK
            const fkontak = { 
...
xdev.sendMessage(from,'Nih Kak Creator DashBot',text,{quoted: hehe})
break
case 'style':
      ...
      xdev.sendMessage(from, hasil, MessageType.text, { quoted: dev});
			...
			break
case 'pastebin':
if(!q) return reply(`Example : DashBot`)
